...
class App extends Component{
  ...
  render(){
    ...
    const cellList = ["번호","프로필 사진","이름","생년월일","성별","직업","설정"]
    return (
      <div className={classes.root}>
        <AppBar position="static" style={{ background: '#FF8EA0' }}>
          <Toolbar>
            <IconButton
              edge="start"
            ...
            <TableBody>
              {
                ...
                :<TableRow>
                  <TableCell colSpan="6" align="center">
                    <CircularProgress className={classes.progress} variant="determinate" value={this.state.completed} color="secondary"></CircularProgress>
                  </TableCell>
                </TableRow>
              }
            </TableBody>
